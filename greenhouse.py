...
while True:
    try:
        ...
        print ("Oli's Greenhouse Temp & Pressure Sensor")
        print ("---------------------------------------")
        ...
        conn = request.urlopen(baseURL + '&field1=%s&field2=%s' % (cTemp, pressure))
        print(str(cTemp))
        conn.close()
        time.sleep(60)
        ...
        print("Unexpected error in Dads program:", sys.exc_info()[0])
        print("Entering sleep mode to wait a minute")
        time.sleep(60)
        print("Sleep done")
        continue
